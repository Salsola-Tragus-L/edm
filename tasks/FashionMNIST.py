...
class FashionTask(Task):
    def __init__(
        ...
        self._test_data = FashionDataset("test", device=self._device)
...
class FashionDataset(PyTorchDataset):
